                        ...
                        <div class="row">	
                            <table border="1" style="width:100%;text-align: center;color: black">
                                ...
                                <tr>
                                    ...
                                    <td><%=rs.getString("tplace")%></td>
                                    <td><%=rs.getString("testim")%></td>
                                    <%

                                        if (rs.getString("status").equals("Nil")) {
                                    %>
                                    <td><a href="tapr.jsp?tid=<%=rs.getString("tid")%>">Approve</a></td>
                                    <% }else{%>
                                     <td>Approved</td>
                                       <%}%>
                                    <td><a href="deltestimony.jsp?tid=<%=rs.getString("tid")%>">Delete</a></td>
                                </tr>
                                <%}%>
                            </table>
                        </div>
