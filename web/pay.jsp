                    ...
                    <div class="col-lg-12 mt-30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 form-group">
                                ...
                                <form action="payaction.jsp" class="form-area contact-form text-left" onsubmit="return check();">
                                    <%
                                        Date d = new Date();
                                    ...
                                    Advance Amount(20%)
                                    <input type="text" class="common-input mb-20  form-control" readonly="" value="<%=(Integer.parseInt(rs.getString("tamt")) * 20) / 100%>" name="adamt"/><br/>
                                    Card Holder Name
                                    ...
                                    <input type="submit" class="genric-btn primary" style="width:100%" value="PAY "/>
                                </form>
                            </div>
                        </div>
