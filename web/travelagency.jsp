...
<html lang="en">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-30">
                        <form class="form-area contact-form text-left" action="travelaction.jsp" onsubmit="return check()">
                            <div class="row">	
                                <div class="col-lg-6 form-group">
                                    Agency name<input type="text" class="common-input mb-20  form-control"name="aname" id="aname" required/>
                                    Address<textarea class="common-textarea form-control" rows="5" name="ads" required/></textarea>
                                    City<input type="text" class="common-input mb-20  form-control" name="city" id="city"  required/>
                                    District<input type="text" class="common-input mb-20  form-control" name="dist" id="dist" required/>
                                </div>
                                <div class="col-lg-6 form-group">

                                    Pincode<input type="text" class="common-input mb-20  form-control" name="pin" id="pin" maxlength="6"required/>
                                    Phone No<input type="text" class="common-input mb-20  form-control" name="phno" id="phno" maxlength="12" required/>
                                    Email Id<input type="email" class="common-input mb-20  form-control" name="em" required/>
                                    Reg No<input type="text"  class="common-input mb-20  form-control"name="regno"  required/>
                                    Password<input type="text" class="common-input mb-20  form-control" name="pass" id="pass">							
                                </div>
    ...
    function check()
    {
        ...
        {
            alert('please input alphabet characters only,enter agency name');
            return false;
        }
