            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <a href="treport.jsp"><button>Report</button></a>
                          <a href="trreport.jsp"><button>Tour Report</button></a>
                    </div>	
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <%
                    ...
                    <tr>
                        ...
                        <td> <a href="luploads/<%=rs.getString("limg")%>"><img src="luploads/<%=rs.getString("limg")%>" width="150px" height="150px"/></a></td>
                        <%
                        ResultSet rs1=DB.executeQuery("select status from tbl_login where uid="+rs.getString("trid")+" and utype='agency'");
                        rs1.next();
                        if(rs1.getString("status").equals("false")){
                        %>
                        <td><a href="apr.jsp?trid=<%=rs.getString("trid")%>">Approve</a></td>
                        <% } %>
                         <td><a href="deltagency.jsp?trid=<%=rs.getString("trid")%>">Delete</a></td>
                        </tr>
                        <%}%>
                        </table>
                            </div>
