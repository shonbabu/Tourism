                    ...
                    <div class="col-lg-12 mt-30">
                            ...
                            <div class="row">	
                                <div class="col-lg-6 form-group">
                                    <form class="form-area contact-form text-left" action="lpicaction.jsp" method="post" enctype="multipart/form-data">
                                                <input type="file" name="file"/><br/>
                                                <% session.setAttribute("trid", request.getParameter("trid"));%>
                                                 <button class="genric-btn primary" style="float: right;">Upload License</button>	
                                            </form>  </div>
