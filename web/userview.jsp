...
<%
                ResultSet rs1 = DB.executeQuery("select count(*) as cnt from tbl_register");
                if(rs1.next()){
            %>
            <p style="color:white"> No of Users :<%=rs1.getString("cnt")%></p>
            <% } %>
                    </div>	
                </div>
            </div>
        ...
        <section class="contact-page-area section-gap">
            ...
            <%
                ResultSet rs = DB.executeQuery("select * from tbl_register");
                while (rs.next()) {
            %>
            ...
            <tr>
              ...
              <!--  <td><a href="deluser.jsp?rid=<%=rs.getString("rid")%>">Delete</a></td>-->
            </tr>
            <%}%>
        </table>
                            </div>
